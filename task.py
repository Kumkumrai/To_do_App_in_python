task managent app using python 
...
def task():
    tasks = []  #empty
    print("____Welcom TO THE TASK MANAGENT APP")
    total_task =int(input("How Many Task you want to add ="))#5 times 
    for i in range(1, total_task+1):
        task_name = input(f"Enter task{i}=")#enter task3
